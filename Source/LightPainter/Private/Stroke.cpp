...
AStroke::AStroke()
{
	...
	StrokeMeshes->SetupAttachment(GetRootComponent());

	JointMeshes = CreateDefaultSubobject<UInstancedStaticMeshComponent>(TEXT("JointMeshes"));
	JointMeshes->SetupAttachment(GetRootComponent());
}
...
void AStroke::Update(FVector CursorLocation)
{
	...
	{
		JointMeshes->AddInstance(GetNextJointTransform(CursorLocation)); //first joint
